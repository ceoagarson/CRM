...
import { CreateProduction, GetProduction, GetProductions, GetProductionsByCategory, GetProductionsByDate, GetProductionsByMachine } from "../controllers/production.controller";
