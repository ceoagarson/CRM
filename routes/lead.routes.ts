...
import { BulkLeadUpdateFromExcel, ConvertCustomer, CreateLead, DeleteLead, GetCustomers, GetLeads, GetmyLeads, NewRemark, UpdateLead } from "../controllers/lead.controller";
