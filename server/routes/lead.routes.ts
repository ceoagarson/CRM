...
import { BulkLeadUpdateFromExcel, ConvertCustomer, CreateLead, DeleteLead, GetCustomers, GetLeads, NewRemark, SendTemplateLeads, UpdateLead } from "../controllers/lead.controller";
...
router.route("/template/leads").get(isAuthenticatedUser, SendTemplateLeads)
