  ...
  return (
    <>
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <AlertBar color="success" open={isSuccess} message="Reset password successfully" />
        <Stack
          direction="column"
          pt={2}
          gap={2}
        >
          ...
          <Button variant="contained"
            ...
            color="primary" type="submit" fullWidth>{Boolean(isLoading) ? <CircularProgress /> : "Reset"}</Button>
        </Stack>
      </form>
    </>
  )
