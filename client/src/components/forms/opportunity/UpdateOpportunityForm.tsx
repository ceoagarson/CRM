...
function UpdateOpportunityForm({ opportunity }: { opportunity: IOpportunity }) {
  const { mutate, isLoading, isSuccess, isError, error } = useMutation
    <AxiosResponse<IOpportunity>, BackendError, {
      id: string,
      body: FormData
    }>
    (UpdateOpportunity, {
  ...
  const formik = useFormik<TformData>({
    initialValues: {
      ...
      mobile: String(opportunity.mobile),
      ...
      alternate_mobile: String(opportunity.alternate_mobile),
